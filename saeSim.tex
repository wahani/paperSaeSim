...
To further process simulation results we present two graphics, using the package \proglang{ggplot2} \citep{wickham09} and \proglang{reshape2} \citep{wickham07} for 
\begin{Schunk}
\begin{Sinput}
