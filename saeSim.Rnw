...
<<designSimBIAS, fig = TRUE, width = 8.3, height=4, include = FALSE>>=
library(ggplot2)
...
<<designSimMSE, fig=TRUE, width = 8.3, height=4, include = FALSE>>=
